...
#import "EOSFTPServerFile.h"
#import "EOSFTPServerFile+Private.h"

@implementation EOSFTPServerFile
...
{
    EOSFTPServerFile * file;
    
    file = [ [ EOSFTPServerFile alloc ] initWithPath: path ];
...
+ ( EOSFTPServerFile * )fileWithURL: ( NSURL * )url
{
    ...
    file = [ [ EOSFTPServerFile alloc ] initWithURL: url ];
